...
1. Download Linux: <https://ubuntu.com> or <https://www.linuxmint.com>
...
>ⓘ **Note**\
>- [Instead of](https://gtkmm.gnome.org/en/) [**gcc**](https://gcc.gnu.org/install/) compiler, a recent version of [**clang**](https://clang.llvm.org/) [compiler will also work!](https://gtkmm.gnome.org/en/)
>- [libgtkmm3](https://gtkmm.gnome.org/en/) is required for [**VSTGUI**](../What+is+the+VST+3+SDK/VSTGUI.md) and the [editorhost](../What+is+the+VST+3+SDK/Index.md#editorhost) example!
>- [Jack Audio](https://jackaudio.org) is required for [audiohost](../What+is+the+VST+3+SDK/Index.md#audiohost) example!
